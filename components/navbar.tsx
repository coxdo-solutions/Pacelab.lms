...
import { User as UserIcon, Settings, LogOut, Menu, X } from "lucide-react"; // FIX: alias User icon to avoid name clash
...
export function Navbar() {
  ...
  // FIX: Make this safe for undefined names and fall back to email or "?".
  const getInitials = (
